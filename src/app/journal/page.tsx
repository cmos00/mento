    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 pb-24 md:pb-6">
        ...
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-xl font-bold text-gray-900">커리어 저널</h2>
          <div className="flex items-center space-x-2">
            <button
        ...
        {/* Progress Overview */}
        <div className="mb-8 bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white rounded-xl p-4">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-gray-600">읽은 아티클</span>
                <span className="text-sm font-semibold text-purple-600">12/20</span>
              </div>
            ...
            <div className="bg-white rounded-xl p-4">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-gray-600">완료한 목표</span>
            ...
            <div className="bg-white rounded-xl p-4">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-gray-600">학습 연속일</span>
                <span className="text-sm font-semibold text-blue-600">7일</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2">
        ...
        {viewMode === 'grid' ? (
          <div className="space-y-6">
            {sortedArticles.map((article) => (
              <Link key={article.id} href={`/journal/${article.id}`} className="block group">
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-start justify-between mb-2">
                            <div className="flex-1">
                              <h3 className="text-lg font-semibold text-gray-900 mb-1 line-clamp-2 group-hover:text-purple-700 transition-colors">{article.title}</h3>
          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {sortedArticles.map((article, index) => (
                <div key={article.id} className="relative flex items-start space-x-6">
                  {/* Timeline Dot */}
                  <div className="relative z-10 w-4 h-4 bg-purple-500 rounded-full border-4 border-white shadow-lg"></div>
                  
                  {/* Content */}
                  <div className="flex-1 bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-all">
                    <Link href={`/journal/${article.id}`} className="block group">
                      <div className="flex items-start space-x-4">
                        {article.image && (
