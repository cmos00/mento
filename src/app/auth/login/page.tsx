      ...
      <div className="w-full max-w-md">
        ...
        <div className="shadow-2xl border-0 bg-white/95 backdrop-blur-md rounded-3xl overflow-hidden">
          ...
          <div className="space-y-4 px-6 pb-6">
            ...
            disabled={true}
            className="w-full bg-gray-400 text-white py-4 rounded-2xl font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-lg flex items-center justify-center"
          >
              {isLoading ? (
                <>
